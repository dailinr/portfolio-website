...
import ExperienceItemMotion from "@/src/components/motion/ExperienceItemMotion.client";
    ...
    <section id="experience" className={`relative w-full bg-background ${STANDARD_SECTION_PY}`}>
      <div className={GLOBAL_CONTAINER}>
        ...
        <div className={TIMELINE_LINE}>
          {experiences.map((exp) => (
            <ExperienceItemMotion key={exp.id}>
              <div className="relative pb-12 pl-6 md:pl-10">
